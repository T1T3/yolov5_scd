...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='yolov5s.pt', help='initial weights path')           # default='yolov5s.pt'
    parser.add_argument('--cfg', type=str, default='models/yolov5s.yaml', help='model.yaml path')    # C:\Users\Zman\PycharmProjects\yolov5\models\yolov5s.yaml
    parser.add_argument('--data', type=str, default='data/coco128.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyps/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=600)                                          #300--->600
    parser.add_argument('--batch-size', type=int, default=16, help='total batch size for all GPUs') #GPU memo 16-->3~4g
